...
<nav class="navbar navbar-dark navbar-expand-sm bg-dark">
	<span class="badge navbar-brand" onclick="reload()">积点<br/>商城</span>
...
<div class="carousel slide bg-secondary" data-ride="carousel">
	...
	<div class="carousel-inner">
		<i class="noimg fa fa-5x fa-image text-white text-center pt-5 mt-5"></i>
...
<div class="d-flex-2 d-flex flex-wrap flex-row small text-nowrap justify-content-center">
	...
	<div class="card overflow-hidden border-0">
		<img class="card-img-top bg-dark" src="{{asset('img/T1pBVsBCJ_1RCvBVdK_800.jpg')}}" />
		<div class="card-body p-0">
			<span class="card-title">全自动洗衣机</span><br/>

...
<nav class="navbar navbar-dark navbar-expand-sm fixed-top text-white">
	...
	<span class="navbar-text mx-auto">短视频</span>
...
<script type="text/javascript">
	$().ready(function(){
		...
		audiolamp();
		$.getJSON('https://v1.alapi.cn/api/video/url',{url:'https://v.kuaishou.com/5SmDdh'},function(data,status,xhr){
		...
		$.getJSON('https://api.uomg.com/api/rand.music',{sort:'热歌榜',format:'json'},function(data,status,xhr){
